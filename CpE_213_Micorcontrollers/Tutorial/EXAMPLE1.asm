...
arith:	MOV B, #10D	; load B with 10 decimal
	...
	call myFun	; call function myFun

stop:	JMP stop	; end, for all practical purposes

;********************************************
; function myFun, in its own code segment
;********************************************
myFunCode segment code	; declare myFun as a segment of type code
	rseg myFunCode 	; begin relocatable code segment myFunCode 

myFun:	MOV A, #01111111B ; pre-load ACC
	ANL A, PSW	; clear ....
